...
class GPTBlogPrompts(Enum):
    ...
    BLOG = "You are a well-loved author of a popular blog that writes about women’s health and wellness. Please write an interesting click worthy article about {0}. Include these keywords: {1}. Keep the title very short, simple and click worthy."
